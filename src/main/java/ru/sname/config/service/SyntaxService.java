...
import ru.sname.config.syntax.AttributeEntry;
import ru.sname.config.syntax.ComponentEntry;
import ru.sname.config.syntax.SubcomponentEntry;
import ru.sname.config.syntax.error.AttributeRequiredError;
import ru.sname.config.syntax.error.InvalidCategoryError;
import ru.sname.config.syntax.error.SubcomponentRequiredError;
import ru.sname.config.syntax.error.SyntaxError;
import ru.sname.config.syntax.error.TooManyValuesError;
import ru.sname.config.syntax.error.UnusedAttributeError;
import ru.sname.config.syntax.error.UnusedSubcomponentError;
